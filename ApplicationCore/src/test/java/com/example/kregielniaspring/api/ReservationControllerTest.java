...
public class ReservationControllerTest {
    ...
    public void addReserv() {
        ...
        Response response = doGetRequest("http://localhost:8080/Kregielnia-1.0-SNAPSHOT/api/reservation");
    ...
    public void deleteReserv() {
        ...
        RestAssured.given().contentType(contentType).delete("http://localhost:8080/Kregielnia-1.0-SNAPSHOT/api/reservation/delete/" + reservUUID).then().assertThat()
                .statusCode(200);
