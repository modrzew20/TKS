...
public class UserServiceTest {
    ...
    @Test
    private void addUserTest() throws LoginInUseException {
    ...
    @Test
    private void updateUserTest() throws LoginInUseException {
    ...
    @Test
    private void activeUserTest() throws LoginInUseException {
        User user = userService.readAllUser().get(0);
