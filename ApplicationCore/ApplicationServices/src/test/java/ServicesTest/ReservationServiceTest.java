...
public class ReservationServiceTest {
    ...
    @BeforeEach
    private void init() throws LoginInUseException {
    ...
    @Test
    private void addReservationTest() {
    ...
    @Test
    private void ClientsReservationTest() {
    ...
    @Test
    private void LaneReservationTest() {
    ...
    @Test
    private void endReservationTest() {
    ...
    @Test
    private void deleteReservationTest() {
